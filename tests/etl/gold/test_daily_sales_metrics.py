...
from cubix_data_engineer_capstone.etl.gold.daily_sales_metrics import get_daily_sales_metrics  # noqa: E501


def test_get_daily_sales_metrics(spark):
    """
    Positive test that the function get_daily_sales_metrics returns the expected DataFrame.  # noqa: E501
    """
    ...
    wide_sales_test = spark.createDataFrame(wide_sales_test_data, schema=wide_sales_test_schema)  # noqa: E501
    ...
    expected = spark.createDataFrame(expected_data, schema=expected_schema)  # noqa: E501
