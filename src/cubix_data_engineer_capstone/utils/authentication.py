...
def _create_authentication_config(tenant_id: str, client_id: str, client_secret: str) -> dict[str, str]:  # noqa: E501
    """Creates the config dictionary needed for Spark authentication for data reading and writing.
    ...
    :return:                Dictionary with the authentication configuration.
    """
    return {
...
def authenticate():
    ...
    if not tenant_id or not client_id or not client_secret:
        raise ValueError("Missing one or more requiered environment variables: AZURE_TENANT_ID, AZURE_CLIENT_ID, AZURE_CLIENT_SECRET.")  # noqa: E501
